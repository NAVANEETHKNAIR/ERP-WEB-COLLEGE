...
<html>
	...
	<div class="bg">
        ...
        <div class="container ">
        	<div class="row">
                ...
                <%
                    ...
                    ResultSet facultyRs=(ResultSet)session.getAttribute("facultyRs");
                    if(msg!=null)  
                    {
                %>
            	...
            	<div class="notice-table col-md-12 pull-left">
                	...
                	<table id="mydata" class=" table table-striped table-bordered hover" cellspacing="0" width="100%">
                    	<thead>
                      	...
                      	<tbody>
                          <%
                          PreparedStatement getAllFaculty=(PreparedStatement)application.getAttribute("getAllFaculty");
                          ...
                          while(rs.next())
                          {
                            ...
                            <%
                                ...
                                getFacultyCourse.setString(1,rs.getString(1) );
                                ResultSet courseRs=getFacultyCourse.executeQuery();
                                String course="";
                                while(courseRs.next())
                                {
                                  course=course+" "+courseRs.getString(2);
                                }
                            %>   
                                <td><%= course %></td>
                                </tr>
        ...
        %>        
            <div class="row">    
                <div class=" col-md-8 ">
                    ...
                    <br>
                    <form action="GetFaculty.jsp" method="post" class="form-inline" data-toggle="validator" role="form">
                        <div class="form-group">
                          <input type="text" value="<%=facultyRs.getString(1)%>" class="form-control" name="fid" placeholder="Faculty ID" required>
                        </div>
                        <button type="submit" class="btn btn-primary">GO</button>
                    </form>

                    <hr>
                    <form action="ModifyFaculty.jsp" method="post" class="form-horizontal" data-toggle="validator" role="form">                          
                            <div class="form-group">
                            <div class="col-sm-10 col-sm-offset-1">
                                <input type="hidden" name="ofid" value="<%=facultyRs.getString(1)%>"/>
                              <input type="text" value="<%=facultyRs.getString(1)%>" class="form-control" name="fid" placeholder="Faculty ID" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-10 col-sm-offset-1">
                              <input type="text" value="<%=facultyRs.getString(2)%>" class="form-control" name="name" pattern="^[_A-z ]{1,}$"placeholder="Name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-10 col-sm-offset-1">
                              <input type="email" value="<%=facultyRs.getString(3)%>" class="form-control" name="email" placeholder="Email ID" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-10 col-sm-offset-1">
                              <input type="text" value="<%=facultyRs.getString(4)%>" class="form-control" name="phone" minlength="10" maxlength="10" placeholder="Mobile No." required>
                            </div>
                        </div>
                        <%
                        PreparedStatement getFacultyCourse=(PreparedStatement)application.getAttribute("getFacultyCourse");
                        getFacultyCourse.setString(1,facultyRs.getString(1) );
                        ResultSet courseRs=getFacultyCourse.executeQuery();
                        String course="";
                        while(courseRs.next())
                        {
                        ...
                        <div class="form-group"> 
                            <div class="col-sm-offset-1 col-sm-10">
                              ...
                              <a href="DelFaculty.jsp?fid=<%=facultyRs.getString(1)%>" class="btn btn-danger">Delete</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <%   
            session.setAttribute("facultyRs", null);
            }
            else
            {    
        %>        
                ...
                <div class=" col-md-8 ">
                    ...
                    <form action="GetFaculty.jsp" method="post" class="form-inline" data-toggle="validator" role="form">
                        <div class="form-group">
                          <input type="text" class="form-control" name="fid" placeholder="Faculty ID" required>
                        </div>
                        <button type="submit" class="btn btn-primary">GO</button>
                    </form>
            ...
            %>
                <div class=" col-sm-4 pull-right">
                	<div class="box">
                        ...
                        <br>
                        <form action="AddFaculty.jsp" method="post" data-toggle="validator" class="form-horizontal" role="form">
